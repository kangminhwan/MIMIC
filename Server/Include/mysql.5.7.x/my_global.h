...
static inline void set_timespec_nsec(struct timespec_mysql *abstime, ulonglong nsec)
{
#ifndef _WIN32
...
static inline void set_timespec(struct timespec_mysql *abstime, ulonglong sec)
{
...
*/
static inline int cmp_timespec(struct timespec_mysql *ts1, struct timespec_mysql *ts2)
{
#ifndef _WIN32
...
static inline ulonglong diff_timespec(struct timespec_mysql *ts1, struct timespec_mysql *ts2)
{
#ifndef _WIN32
